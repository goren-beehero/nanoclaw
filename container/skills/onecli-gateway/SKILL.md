...
connected Google APIs to read, create, copy, and edit files stored in Google
Drive. This permission applies across Drive-hosted file types and includes file
content, formatting, comments, and ordinary file metadata. The presence or
absence of a product-specific helper tool is not the capability boundary.
